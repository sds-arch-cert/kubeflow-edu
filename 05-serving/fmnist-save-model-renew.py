...
if __name__ == '__main__':
    if os.getenv('FAIRING_RUNTIME', None) is None:
        ...
        fairing.config.set_builder(
            ...
            base_image='brightfly/kubeflow-jupyter-lab:tf2.0-gpu', # gpu # here
#            base_image='kubeflow-registry.default.svc.cluster.local:30000/kubeflow-jupyter-lab:tf2.0-cpu-v2', # here
            registry=DOCKER_REGISTRY, 
            push=True)
        # cpu 2, memory 5GiB
        fairing.config.set_deployer('job',
                                    namespace='kubeflow-inkook-kim',  # here namespace akns
                                    pod_spec_mutators=[
